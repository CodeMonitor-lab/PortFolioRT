  ...
  return (
    <main className='min-w-screen bg-gradient-to-b from-purple-200 to-bg-purple-300 border-w-full' >
      ...
      <div className='flex justify-centern text-center sm:text-center' >
          ...
          <h1 className="text-center text-purple-900 md:text-left leading-10 sm:leading-[4.275rem] sm:text-6xl text-3xl font-serif font-extrabold">{headerData[0].heading}</h1>
        ...
        <ProfileImage/>
          ...
          <p className='text-xl text-purple-900 text-shadow-black text-center md:text-center leading-7 sm:leading-10 font-serif font-light md:text-3xl sm:text-3xl sm:pb-3 pb-3 ' >{headerData[0].para}</p>
          </div>
          <div className='flex bg-gradient-to-b from-sky- items-center justify-center font-extrabold text-lg gap-2 py-2' >
          <button className='cursor-pointer  shadow-sm hover:bg-gradient-to-tr bg-gradient-to-tl from-sky-300 to-purple-500 rounded-full px-7 py-2 ' >Discover Profile </button>
          <TiArrowRightThick color={'darkpurple'} />
          </div>
        </article>
      </section>
    </main>
